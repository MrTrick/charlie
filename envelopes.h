//
// These waveforms are taken from http://elm-chan.org/works/mxb/report.html
// Waveforms; Melody Generator  (C)ChaN, 2005
//


// Envelope Curve - plots waveform decay
// \
//  \
//   \
//    `.
...
#define DECAY_SIZE 256
rom near unsigned char decay_table[DECAY_SIZE] = {
...
#define ATTACK_SIZE 896
#define LOOP_SIZE 128
#define WAVE_OVERFLOW_MASK 0x04
rom near signed char wave_table[ATTACK_SIZE+LOOP_SIZE] = {
// Attack waveform - when first played
//   
//       /\
// _/\__/__\____
//    \/    \  /
...
// Loop/Sustain waveform - for duration of note
//    _
//   / \
// _/___\______
//       \   /
